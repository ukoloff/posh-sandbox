...
If %xOS%==x86 (start "" "%~dp0OCSNG-Windows-Agent-2.1.1.1-xp-2003r2\OCS-NG-Windows-Agent-Setup.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY) Else (start "" "%~dp0OCSNG-Windows-Agent-2.1.1.1-xp-2003r2\OCS-NG-Windows-Agent-Setup.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY)
goto :end
...
Set xOS=x64
If "%PROCESSOR_ARCHITECTURE%"=="x86" If Not Defined PROCESSOR_ARCHITEW6432 Set xOS=x86
If %xOS%==x86 (start "" "%~dp0OCSNG-Windows-Agent-2.4.0.0\OCS-NG-Windows-Agent-Setup.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY) Else (start "" "%~dp0OCS-Windows-Agent-2.6.0.0\OCS-NG-Windows-Agent-Setup.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY)
goto :end
...
Set xOS=x64
If "%PROCESSOR_ARCHITECTURE%"=="x86" If Not Defined PROCESSOR_ARCHITEW6432 Set xOS=x86
If %xOS%==x86 (start "" "%~dp0OCS-Windows-Agent-2.10.1.0\OCS-Windows-Agent-Setup-x86.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY) Else (start "" "%~dp0OCSNG-Windows-Agent-2.10.1.0\OCS-Windows-Agent-Setup-x64.exe" /S /NOSPLASH /NOW /SSL=0 /SERVER=http://10.33.10.72:80/ocsinventory /DEBUG=0 /TAG="UXM" /NO_SYSTRAY)
goto :end
